...
/* package swinging-wheel-backend-0.1.0.0 */
#ifndef VERSION_swinging_wheel_backend
#define VERSION_swinging_wheel_backend "0.1.0.0"
#endif /* VERSION_swinging_wheel_backend */
#ifndef MIN_VERSION_swinging_wheel_backend
#define MIN_VERSION_swinging_wheel_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_swinging_wheel_backend */
...
/* package http-types-0.12.6 */
#ifndef VERSION_http_types
#define VERSION_http_types "0.12.6"
...
#define CURRENT_COMPONENT_ID "swinging-wheel-backend-0.1.0.0-inplace-swinging-wheel-backend"
